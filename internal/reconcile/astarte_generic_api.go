		...
		Containers: []v1.Container{
			{
				...
				ReadinessProbe:  getAstarteReadinessProbe(component, api.AstarteGenericClusteredResource),
				LivenessProbe:   getAstarteLivenessProbe(component, api.AstarteGenericClusteredResource),
				StartupProbe:    getAstarteStartupProbe(api.AstarteGenericClusteredResource),
			},
		},
...
func getAstarteGenericAPIEnvVars(deploymentName string, cr *apiv2alpha1.Astarte, api apiv2alpha1.AstarteGenericAPIComponentSpec, component apiv2alpha1.AstarteComponent) []v1.EnvVar {
	...
	case apiv2alpha1.Housekeeping:
		ret = append(ret, getAstarteHousekeepingEnvVars(cr)...)
...
func getAstarteHousekeepingEnvVars(cr *apiv2alpha1.Astarte) []v1.EnvVar {
	ret := []v1.EnvVar{}
