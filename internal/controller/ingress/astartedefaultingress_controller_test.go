...
var _ = Describe("AstarteDefaultIngress Controller", func() {
	Context("When reconciling a resource", func() {
		...
		// }
		// astartedefaultingress := &ingressv1alpha1.AstarteDefaultIngress{}

		BeforeEach(func() {
			// By("creating the custom resource for the Kind AstarteDefaultIngress")
			// err := k8sClient.Get(ctx, typeNamespacedName, astartedefaultingress)
