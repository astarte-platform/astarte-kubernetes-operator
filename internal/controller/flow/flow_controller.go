...
func (r *FlowReconciler) computeFlowStatusResource(reqLogger logr.Logger, instance *flowv2alpha1.Flow) (flowv2alpha1.FlowStatus, error) {
	...
	if err != nil {
		return flowv2alpha1.FlowStatus{}, err
	}
	...
	case instance.Status.TotalContainerBlocks == 0:
		instance.Status.State = flowv2alpha1.FlowStateUnknown
	case instance.Status.FailingContainerBlocks > 0:
		instance.Status.State = flowv2alpha1.FlowStateUnhealthy
	case instance.Status.TotalContainerBlocks != instance.Status.ReadyContainerBlocks:
		instance.Status.State = flowv2alpha1.FlowStateUnstable
	case instance.Status.TotalContainerBlocks == instance.Status.ReadyContainerBlocks:
		instance.Status.State = flowv2alpha1.FlowStateFlowing
	}
...
func (r *FlowReconciler) getAllBlocksForFlow(instance *flowv2alpha1.Flow) (map[string]appsv1.Deployment, error) {
	blockList, err := r.getAllBlocksDeploymentsForFlow(instance)
	if err != nil {
		return nil, err
	}
...
func (r *FlowReconciler) getAllBlocksDeploymentsForFlow(instance *flowv2alpha1.Flow) (appsv1.DeploymentList, error) {
...
func (r *FlowReconciler) computeBlocksState(reqLogger logr.Logger, blockList appsv1.DeploymentList, instance *flowv2alpha1.Flow) (int, int, int, v1.ResourceList, []v1.ContainerState) {
