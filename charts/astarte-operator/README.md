...
![Version: 26.7.0-rc.4](https://img.shields.io/badge/Version-26.7.0--rc.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 26.7.0-rc.4](https://img.shields.io/badge/AppVersion-26.7.0--rc.4-informational?style=flat-square)
...
| image.tag | string | `"26.7.0-rc.4"` | Overrides the image tag whose default is the chart appVersion. |
