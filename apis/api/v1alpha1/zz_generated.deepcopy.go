...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodLabelsGetter) DeepCopyInto(out *PodLabelsGetter) {
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodLabelsGetter.
func (in *PodLabelsGetter) DeepCopy() *PodLabelsGetter {
	if in == nil {
		return nil
	}
	out := new(PodLabelsGetter)
	in.DeepCopyInto(out)
	return out
}
