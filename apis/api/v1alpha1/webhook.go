...
func validatePodLabelsForClusteredResources(r *Astarte) error {
	resources := []commontypes.PodLabelsGetter{r.Spec.VerneMQ.AstarteGenericClusteredResource,
...
func validatePodLabelsForClusteredResource(r commontypes.PodLabelsGetter) error {
