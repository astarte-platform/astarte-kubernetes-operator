...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AstarteFDOIngress) DeepCopyInto(out *AstarteFDOIngress) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AstarteFDOIngress.
func (in *AstarteFDOIngress) DeepCopy() *AstarteFDOIngress {
	if in == nil {
		return nil
	}
	out := new(AstarteFDOIngress)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AstarteFDOIngress) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AstarteFDOIngressList) DeepCopyInto(out *AstarteFDOIngressList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AstarteFDOIngress, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AstarteFDOIngressList.
func (in *AstarteFDOIngressList) DeepCopy() *AstarteFDOIngressList {
	if in == nil {
		return nil
	}
	out := new(AstarteFDOIngressList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AstarteFDOIngressList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AstarteFDOIngressSpec) DeepCopyInto(out *AstarteFDOIngressSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AstarteFDOIngressSpec.
func (in *AstarteFDOIngressSpec) DeepCopy() *AstarteFDOIngressSpec {
	if in == nil {
		return nil
	}
	out := new(AstarteFDOIngressSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AstarteFDOIngressStatus) DeepCopyInto(out *AstarteFDOIngressStatus) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.IngressStatus.DeepCopyInto(&out.IngressStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AstarteFDOIngressStatus.
func (in *AstarteFDOIngressStatus) DeepCopy() *AstarteFDOIngressStatus {
	if in == nil {
		return nil
	}
	out := new(AstarteFDOIngressStatus)
	in.DeepCopyInto(out)
	return out
}
