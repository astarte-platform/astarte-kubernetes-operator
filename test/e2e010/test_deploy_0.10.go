...
func astarteDeploy010Test(t *testing.T, f *framework.Framework, ctx *framework.Context) error {
	...
	if err := utils.EnsureAstarteServicesReadinessUpTo011(namespace, f, true); err != nil {
		return err
	}
