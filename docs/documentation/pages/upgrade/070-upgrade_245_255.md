...
### Step 4: Restore devices CA and housekeeping keys
...
### Step 5: Uninstall NGINX Ingress Controller (OPTIONAL)
...
### Step 6: Install HAProxy Ingress Controller (OPTIONAL)
...
### Step 7: Deploy Astarte Operator v25.5.x
...
### Step 8: Apply converted Astarte and ADI CRs
